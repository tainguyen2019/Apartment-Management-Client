...
const success = (data: ReceiptDetailResponse) => ({
...
export const getReceiptDetails = (id: string) => async (dispatch: Dispatch) => {
  dispatch(request());
  const response = await receiptService.getDetails(id);
